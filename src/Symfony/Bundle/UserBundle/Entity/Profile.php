...
namespace Symfony\Bundle\UserBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="Symfony\Bundle\UserBundle\Repository\ProfileRepository")
 */
class Profile
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Symfony\Bundle\UserBundle\Entity\User", inversedBy="profile")
     * @ORM\JoinColumns({
